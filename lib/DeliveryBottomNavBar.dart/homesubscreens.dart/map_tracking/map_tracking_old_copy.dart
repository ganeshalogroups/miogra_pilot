...
// //       print('Check/......1');
// // print( "orderfirebaseid:${widget.orderId}");
...
// //         if (widget.orderId.toString() == null||widget.orderId.toString().isEmpty) {
...
// void listenToLocationChanges() {
//   locationSubscription = locationService.onLocationChanged.listen((locationData) async {
//     if (locationData != null) {
...
//           calculateDistance(lastUpdatedLocation!, newLocation) >= minDistanceThreshold) {
...
//         moveCameraToBounds(polylines.expand((polyline) => polyline.points).toList());
//       }
//     }
//   }});
// }
...
//     final String apiKey = "AIzaSyCxjzqu6TtZl--tNK_tK6IhAdrTo2AwYc0";
