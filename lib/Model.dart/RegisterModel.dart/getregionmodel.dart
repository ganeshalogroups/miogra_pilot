...
regionPincodes: json["regionPincodes"] != null
            ? List<String>.from(json["regionPincodes"].map((x) => x))
            : null,        regionLat: json["regionLat"],
...
"regionPincodes": regionPincodes != null
            ? List<dynamic>.from(regionPincodes!.map((x) => x))
            : null,
                    "regionLat": regionLat,
